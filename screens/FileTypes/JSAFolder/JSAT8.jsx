...
export default function JSAT8(props) {
  ...
  useEffect(() => {
    ...
    if (Object.keys(Line1).length !== 0) {
      props.setT8(props.T8, (props.T8[1] = { Line1 }));
    }
    if (Object.keys(Line2).length !== 0) {
      props.setT8(props.T8, (props.T8[2] = { Line2 }));
    }
    if (Object.keys(Line3).length !== 0) {
      props.setT8(props.T8, (props.T8[3] = { Line3 }));
    }
    if (Object.keys(Line4).length !== 0) {
      props.setT8(props.T8, (props.T8[4] = { Line4 }));
    } else if (props.T8 !== undefined) {
      if (props.T8[0] !== undefined) {
        setLine0(props.T8[0].Line0);
      }
      if (props.T8[1] !== undefined) {
        setLine1(props.T8[1].Line1);
      }
      if (props.T8[2] !== undefined) {
        setLine2(props.T8[2].Line2);
      }
      if (props.T8[3] !== undefined) {
        setLine3(props.T8[3].Line3);
      }
      if (props.T8[4] !== undefined) {
        setLine4(props.T8[4].Line4);
      }
    }
